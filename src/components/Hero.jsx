...
import heroVideo from '../assets/hero/portfolio-hero.mp4';
...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    // IntersectionObserver to stop video and audio when scrolled away
    ...
    // Scroll listener fallback to instantly pause when scrolling down to next section
    const handleScroll = () => {
      if (sectionRef.current && videoRef.current && !videoRef.current.paused) {
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          >
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-4 py-2 md:px-6 md:py-2 text-xs md:text-base rounded-full bg-transparent border border-white/50 text-white font-semibold hover:bg-white hover:text-black transition-all duration-300 backdrop-blur-md flex items-center gap-2 shadow-sm"
            >
